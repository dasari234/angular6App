    ...
    this.activeRouter.paramMap.subscribe((route: any) => {
      ...
      this.weather.getForecast(this.city).subscribe((data: any) => {
        for (let i = 0; i < data.length; i++) {
          ...
          } else if (!!this.day5Name && !this.day6Name && days[date] !== this.day5Name) {
            this.day6Name = days[date];
            this.day6State = data[i].weather[0].main;
            this.day6Temp = Math.round(data[i].main.temp);
